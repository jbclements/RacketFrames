...
(provide:
 ...
 [data-frame-rename (Frame Label Label -> Frame)]
 [data-frame-project (Frame LabelProjection -> Frame)]
 [data-frame-drop (Frame Label -> Frame)]
 [data-frame-remove (Frame LabelProjection -> Frame)]
 [data-frame-explode (Frame [#:project LabelProjection] -> Columns)]
 [data-frame-replace (Frame Column -> Frame)]
 [data-frame-extend  (Frame (U Column Columns Frame) -> Frame)]
 [data-frame-description (Frame [#:project LabelProjection] -> FrameDescription)]
 [show-data-frame-description (FrameDescription -> Void)])

(provide
 DataFrame Column Columns
 (struct-out DataFrameDescription)
 data-frame-series
 data-frame-names frame-dim 
 data-frame-cseries frame-nseries
 data-frame-series
 new-frame)
