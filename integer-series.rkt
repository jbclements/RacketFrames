...
(check-equal? (iseries-iref g-series-integer 0) 1)

(check-equal? (iseries-iref g-series-integer 1) 2)

(check-equal? (iseries-label-ref g-series-integer 'd) 4)

(check-equal? (iseries-label-ref g-series-integer 'c) 3)
